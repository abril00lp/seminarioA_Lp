...
<?php
  ...
  <center><h1>PRODUCTOS</h1></center>
    <!-- INICIA BOTON -->
    <br>
    <center> <a href="insertar_producto.php" onclick="preguntar('<?php echo $consulta['codigo'];?>')"><Button>Insertar</Button></a><center>
    <br>
      ...
      <table border="1">
        ...
        <tr>
          ...
          <td>
            ...
            ?>
            <a href="actualizar_producto.php?codigo=<?php echo $consulta['codigo'];?>"><Button>Actualizar</Button></a>
            <a href="#" onclick="preguntar('<?php echo $consulta['codigo'];?>')"><button type="button" class="btn btn-danger">Eliminar</button>
            <?php }else{ ?>
