    ...
    <center>
      <table border="1">
        ...
        <?php
          ...
          $sql = "SELECT imagen , descripcion, precio, id_folio  FROM ventas INNER JOIN producto ON ventas.id_articulo = producto.codigo WHERE id_comprador = '$usuario' and estatus = 'Comprado'";
          //CONSULTAR
        ...
        <!-- 
         ...
         -->
        <tr>
          <td><img src="<?php echo $consulta['imagen'];?>" alt=""></td>
