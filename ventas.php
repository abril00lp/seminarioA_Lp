...
<?php
  ...
  <div class="container">
	<div class="row">
      ...
      <br>
  <center><h1>VENTAS TOTALES</h1></center>
    <!-- INICIA BOTON -->
    <center>
    ...
    <center>
      <table border="1">
        ...
        <?php
          ...
          $sql = "SELECT imagen , descripcion, precio, id_folio  FROM ventas INNER JOIN producto ON ventas.id_articulo = producto.codigo WHERE estatus = 'Comprado'";
          //CONSULTAR
